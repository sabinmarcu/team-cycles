...
const getSession = async (id: string) => kv.get<SessionData>(`${sessionPrefix}${id}`);

const createSession = async (id: string, data: SessionData) => kv.set(`${sessionPrefix}${id}`, JSON.stringify(data));
